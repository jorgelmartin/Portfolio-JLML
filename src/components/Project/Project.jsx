...
style={{
    ...
    background: 'radial-gradient(circle, rgba(199,101,235,1) 3%, rgba(151,70,181,1) 28%, rgba(192,135,203,1) 54%, rgba(159,83,185,1) 65%, rgba(157,131,179,0.9136904761904762) 93%)',
    padding: '1em',
    color: 'black',
    margin:'1em',
    borderRadius: '2em',
